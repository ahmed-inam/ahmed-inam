...
**[Dual-core out-of-order RISC-V](https://github.com/ahmed-inam/dual-core-ooo-riscv)**: a dual-core, two-wide
...
seven stages. Start with [`docs/overview.pdf`](https://github.com/ahmed-inam/dual-core-ooo-riscv/blob/main/docs/overview.pdf).
